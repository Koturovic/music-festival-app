  ...
  <div class="row text-center">
    <div class="col-md-6 mb-5">
      ...
      <form method="POST" action="../Backend/komentar_ocena.php">
        <input type="hidden" name="izvodjac" value="Dragana Mirkovic">
        ...
        <div class="d-flex gap-2 justify-content-center">
          ...
          <button id="Dodaj-u-omiljene" class="submit-btn" type="button" data-izvodjac="Dragana Mirkovic">Dodaj u omiljene</button>
    ...
    <div class="col-md-6 mb-5">
      ...
      <a href="https://www.youtube.com/watch?v=2Q_ZzBGPdqE" target="_blank" class="btn btn-warning mt-2">Pogledaj intervju sa izvođačem</a>
    </div>
  </div>
</div>

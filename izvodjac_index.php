...
<div class="container text-center mt-5" id="izvodjac_naslov">
  <h2 class="mb-3">KAO IZVODJAC IMATE MOGUCNOST DA DODATE NOVE DOGADJAJE I INFORMACIJE O SEBI</h2>
    <button class="btn btn-outline-dark learn-more-btn" onclick="window.location.href='izvodjac_edit.php'">Dodaj informacije o sebi</button>
